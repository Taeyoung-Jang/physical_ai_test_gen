...
from .audit import initial_data
from .contact_control import ContactControl
from .push_probe import ArmGaitController


def run_probe(model, groot_root, root, *, kind="push_contact", duration=18.0, initial_y=0.0):
    ...
    with (
        ...
        for step in range(int(duration / model.opt.timestep)):
            ...
            supervisor.observe_contact(step_contact, step_force, model.opt.timestep)
